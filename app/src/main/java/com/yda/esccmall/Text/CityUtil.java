...
public class CityUtil {
    ...
    public static List<City> getCityList() {
        ...
        final int AN_HUI_ICON = R.mipmap.ic_info;
        ...
        final int ZHE_JIANG_ICON = R.mipmap.cross;
        ...
        final int JIANG_SU_ICOM = R.mipmap.username;
    ...
    public static List<City> getRandomCityList() {
        ...
        for (int i = 0; i < provinceSize; i++) {
            ...
            for (int j = 0; j < citySize; j++) {
                dataList.add(new City(province + " : city " + j, province, R.mipmap.username));
            }
        }
        return dataList;
    }
