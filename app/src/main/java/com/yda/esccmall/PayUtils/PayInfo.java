package com.yda.esccmall.PayUtils;
...
public class PayInfo {
    //初始化
    public static String WI_APP_ID = "wx1fe8e2c4de9667f5";
    public static String WI_App_Secret = "606d966b1cc128db93296b8d0c735e96";
    public static String WI_MER_ID = "1505514201";
    public static String WI_API_KEY = "123456abcdefghijklmnopqrstuvwxyz";
    public static String WI_CALL_BACK="http://app.szcsf.cn/api/payment/wxh5pay/notify_url.aspx";
