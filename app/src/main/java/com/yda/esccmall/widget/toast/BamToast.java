package com.yda.esccmall.widget.toast;
...
import static com.yda.esccmall.widget.toast.BToast.ICONTYPE_ERROR;
import static com.yda.esccmall.widget.toast.BToast.ICONTYPE_NONE;
import static com.yda.esccmall.widget.toast.BToast.ICONTYPE_SUCCEED;
...
public class BamToast {
    ...
    private BamToast(Context context, CharSequence text, int time,
        ...
        if (context instanceof Application)
            ...
            checkNotification = Util.isNotificationEnabled(context) ? 0 : 1;
