...
public class DeviceUtils {
    ...
    public static void SofiaInit(Activity activity,int status_color,int navigat_color,int status_alpha,int navigat_alpha){
        Sofia.with(activity)
                .invasionStatusBar()
                .statusBarBackground(status_color)
                .statusBarBackgroundAlpha(status_alpha)
                .invasionNavigationBar()
                .navigationBarBackground(navigat_color)
                .navigationBarBackgroundAlpha(navigat_alpha);
    }
}
