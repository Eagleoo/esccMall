...
public class GameScreen extends Screen {
    ...
    private void drawReadyUI() {
        ...
        g.drawImage(Assets.getReadyTap, matrix, gameWidth/2.67, gameHeight/2, 0, res, false);
    }
    ...
    private void drawGameOverUI() {
        ...
        if 	(score < 50)  
        	g.drawImage(Assets.portrait, matrix, gameWidth/4, gameHeight/1.75, 0, res, true);
        else if (score < 100)
